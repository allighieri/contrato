	...
	<section>
		...
		<form id="form_insere_cliente" name="form" autocomplete="off">
			...
			<div class="label-float">
				<input id="cpf_cnpj" type="text" name="cpf_cnpj" value="<?php echo isset($final_data['CPF']) ? $final_data['CPF'] : ""; ?>" placeholder=" " />
				 <label>CPF/CNPJ</label>
				 <span class="check"></span>
			</div>

			<div class="label-float">
				<input id="nome" type="text" name="nome" value="<?php echo isset($final_data['NOME COMPLETO']) ? $final_data['NOME COMPLETO'] : ""; ?>" placeholder=" "/>
				 <label>Nome/Razão Social</label>
			</div>
			
			<div class="col2x-left">			
				<div class="label-float">
					<input id="telefone" type="text" name="telefone" value="<?php echo isset($final_data['TELEFONE']) ? $final_data['TELEFONE'] : ""; ?>" placeholder=" "/>
			...
			<div class="col2x-right">				
				<div class="label-float">
					<input id="email" type="email" name="email" value="<?php echo isset($final_data['EMAIL']) ? $final_data['EMAIL'] : ""; ?>" placeholder=" "/>
					 <label>E-mail</label>
				</div>
			</div>
						...
						success: function(data){
							...
							console.log(res.erro);	
								...
								if (value.length >= 15 && value.length <= 17 ){
									...
									$(".check").fadeTo(100, 1).html('<span class="errado" title="Este CPF/CNPJ já está associado a um cliente">X</span>');
									$('#btn_enviar').addClass('disabled');
									$('#btn_enviar').prop("disabled", true);
								}
							...
							if(res.status == 0){ // se não houver um cpf/cnpj já cadastrado mostra um "ok" e habilita o botão de cadastrar
								...
								if (value.length >= 15 && value.length <= 17 ){
									...
									$(".check").fadeTo(100, 1).html('<span class="correto"  title="CPF/CNPJ livre para cadastro">&#10004;</span>');
