...
$sql= "SELECT 
		...
		$instalacaoData = new DateTime(utf8_encode($linhasEventos['instalacao'])); // Pega o momento atual
		$instalacaoHora = new DateTime(utf8_encode($linhasEventos['instalacao'])); // Pega o momento atual
				
		$retiradaData = new DateTime(utf8_encode($linhasEventos['retirada'])); // Pega o momento atual
		$retiradaHora = new DateTime(utf8_encode($linhasEventos['retirada'])); // Pega o momento atual		
...
<body>	
	...
	<section>
		...
		<form id="form_insere_evento" name="form" autocomplete="off">
			...
			<input id="idCliente" type="hidden" name="idCliente" value="<?php echo $linhasEventos['idCliente']; ?>"/>
			<input id="acao" type="hidden" name="acao" value="editar" placeholder=" "/>

			
			<div class="label-float">
				<input id="nome" type="text" name="nome" value="<?php echo $linhasEventos['nome']; ?>" placeholder=" " disabled />
				 <label>Cliente</label>
			...
			<div class="label-float">
				<input id="bairro" type="text" name="bairro" value="<?php echo $linhasEventos['bairro']; ?>" placeholder=" "/>
				 <label>Bairro</label>
			</div>

			<div class="col2x-left">				
				<div class="label-float">
					<input id="cidade" type="text" name="cidade" value="<?php echo $linhasEventos['cidade']; ?>" placeholder=" "/>
					 <label>Cidade</label>
				</div>
			</div>	
			...
			<div class="col2x-right">
				<div class="label-float">
					<input id="uf" type="text" name="uf" value="<?php echo $linhasEventos['uf']; ?>" placeholder=" "/>
					 <label>UF</label>
				</div>
			</div>	
			...
			<div class="col2x-left">				
				<div class="label-float">
					<input id="instalacao" type="date" name="instalacao" value="<?php echo $instalacaoData->format('Y-m-d'); ?>" placeholder=" "/>
			...
			<div class="col2x-right">
				<div class="label-float">
					<input id="horainstalacao" type="time" step="0" name="horainstalacao" value="<?php echo $instalacaoHora->format('H:i'); ?>" placeholder=" "/>
			...
			<div class="col2x-left">				
				<div class="label-float">
					<input id="retirada" type="date" name="retirada" value="<?php echo $retiradaData->format('Y-m-d'); ?>" placeholder=" "/>
			...
			<div class="col2x-right">
				<div class="label-float">
					<input id="horaretirada" type="time" step="0" name="horaretirada" value="<?php echo $retiradaHora->format('H:i'); ?>" placeholder=" "/>
					 <label>Hora Retirada</label>
				</div>			
			</div>

			<div class="label-float">
				<input id="nomeStatus" type="text" name="nomeStatus" value="<?php echo $linhasEventos['nomeStatus']; ?>" placeholder=" "/>
				<input id="idStatus" type="hidden" name="idStatus" value="<?php echo $linhasEventos['idStatus']; ?>" placeholder=" "/>
