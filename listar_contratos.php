...
$sql= "SELECT 
			...
			INNER JOIN eventos as e ON ct.idEventos = e.idEventos
			INNER JOIN cliente as c ON ct.idCliente = c.idCliente
			INNER JOIN aparelhos as a ON ct.idAparelhos = a.idAparelhos
			INNER JOIN status as s ON ct.idStatus = s.idStatus
		";
...
<body>	
	...
	<a href="form_contrato.php" class="btn_cadastrar_novo" title="Cadastrar um novo template">NOVO CONTRATO</a>
	<div class="clear"></div>
