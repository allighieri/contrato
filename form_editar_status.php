...
<?php
	...
	$idStatus = isset($_GET['id']) ? $_GET['id'] : "";
...
<body>	
	...
	<section>
		...
		<form id="form_editar_status" name="form" autocomplete="off">
			<h2>Editar Status:</h2>
			
			<input id="idStatus" type="hidden" name="idStatus" value="<?php echo $idStatus; ?>"/>
			<input id="acao" type="hidden" name="acao" value="editar" placeholder=" "/>
			

			<div class="label-float">
				<input id="nome" type="text" name="nome" value="<?php echo isset($linhasStatus['nome']) ? $linhasStatus['nome'] : "" ;?>" placeholder=" "/>
				 <label>Nome</label>
			</div>
...
<script>
	...
	//INSERE EVENTO
	$(document).on('submit','#form_editar_status',function(){
