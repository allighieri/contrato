	...
	<section>
		...
		<form id="form_insere_aparelhos" name="form" autocomplete="off">
			...
			<div class="col2x-right">
				<div class="label-float">
					<input id="modelo" type="text" name="modelo" value="" placeholder=" "/>
					 <label>Modelo</label>
				</div>
			</div>			
			...
			<div class="col2x-left">
				<div class="label-float">
					<input id="serial" type="text" name="serial" value="" placeholder=" "/>
					 <label>Serial</label>
				</div>
			</div>
			...
			<div class="col2x-right">
				<div class="label-float">
					<input id="musicas" type="text" name="musicas" value="" placeholder=" "/>
					 <label>Músicas</label>
				</div>
			</div>	
			...
			<div class="checkbox">
				<label> Item padrão: </label>
				  <input type="radio" id="padraosim" name="padrao" value="1" /> <span><label class="for" for="padraosim"> Sim</label></span>
				  <input type="radio" id="padraonao" name="padrao" value="0" checked /> <span><label class="for" for="padraonao"> Não</label></span>
			</div>
