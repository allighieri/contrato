...
<body>	
	...
	<section>
		...
		<form id="form_insere_itens" name="form" autocomplete="off">
			<h2>Cadastrar Itens:</h2>
			
			<div class="col2x-left">
				<div class="label-float">
					<input id="descricao" type="text" name="descricao" value="" placeholder=" "/>
					 <label>Item</label>
				</div>
			</div>
			...
			<div class="col2x-right">
				<div class="label-float">
					<input id="qtde" type="number" name="qtde" value="1" placeholder=" "/>
...
<script>
	...
	//INSERE EVENTO
	$(document).on('submit','#form_insere_itens',function(){
